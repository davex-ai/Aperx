...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeResponse> getEmployee(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(employeeService.getById(id, privileged));
    }
    ...
    public ResponseEntity<EmployeeResponse> createEmployee(@Valid @RequestBody CreateEmployeeRequest request) {
        AuthService.EmployeeCreationResult result = authService.createEmployeeAccount(request);
        EmployeeResponse response = employeeService.getById(result.employee().getId(), true);
        response.setInvitationSent(result.invitationSent());
    ...
    public ResponseEntity<Boolean> resendInvitation(@PathVariable Long id) {
        return ResponseEntity.ok(authService.resendInvitation(id));
    }
}
