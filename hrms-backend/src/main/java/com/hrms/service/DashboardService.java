...
public class DashboardService {
    ...
    public DashboardStatsResponse getStats(Long companyId) {
        ...
        long pendingLeave = leaveRequestRepository.countByEmployeeCompanyIdAndStatus(companyId, LeaveStatus.PENDING);
        long openJobs = jobPostingRepository.findByCompanyIdAndStatus(companyId, JobStatus.OPEN).size();
